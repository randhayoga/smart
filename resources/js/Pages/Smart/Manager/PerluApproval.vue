      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex flex-wrap gap-3 items-center w-full sm:w-auto">
          ...
          <Combobox
            ...
            width-class="w-full sm:w-auto min-w-[130px]"
          />

          <!-- Pemanfaatan Filter -->
          <Combobox
            v-model="utilizationFilter"
            :options="['Corporate', 'Project']"
            search-placeholder="Cari pemanfaatan..."
            default-label="Semua pemanfaatan"
            width-class="w-full sm:w-auto min-w-[175px]"
          />
        </div>
      ...
      <table class="w-full text-xs text-left border-collapse">
        <thead class="bg-muted/50 border-b border-border text-foreground">
          <tr class="hover:bg-transparent text-foreground font-semibold">
            <th class="py-4 px-4 w-12 text-center font-semibold">
            ...
            <th @click="toggleSort('number')" class="py-4 px-4 cursor-pointer select-none font-semibold">
        ...
        <tbody>
          ...
          >
            ...
            <td class="py-4 px-4 font-mono font-medium text-foreground">{{ req.number }}</td>
