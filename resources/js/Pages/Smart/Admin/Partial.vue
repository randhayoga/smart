...
const dummyInbox = computed(() => props.inboxItems);
...
<template>
  <AppLayout title="Partial">
    <Breadcrumb>
      <BreadcrumbList class="pb-3">
        <BreadcrumbItem>
          <BreadcrumbLink href="/smart/partial">Partial</BreadcrumbLink>
        </BreadcrumbItem>
      </BreadcrumbList>
    </Breadcrumb>
    ...
    <div class="space-y-4">
      ...
      <div class="px-4 bg-card rounded-xl border border-border shadow-sm overflow-hidden">
        <div class="py-5 no-print">
          <h2 class="text-lg font-bold text-foreground">Daftar Permintaan Tertunda (Partial)</h2>
