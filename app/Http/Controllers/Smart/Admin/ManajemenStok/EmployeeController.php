...
class EmployeeController extends Controller
{
    ...
    {
        // Single grouped SQL query to calculate currently borrowed non-consumable assets per NPK
        $activeAssetCounts = DB::table('request_fulfillments as rf')
            ...
            ->join('adm_users as u', 'u.id', '=', 'r.user_id')
            ...
            ->groupBy('u.employee_id')
            ->select('u.employee_id', DB::raw('COUNT(DISTINCT rf.unit_id) as total_assets'))
            ->pluck('total_assets', 'u.employee_id');
