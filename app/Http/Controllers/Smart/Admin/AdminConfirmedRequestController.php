...
/**
 * Admin Confirmed Request Controller managing newly confirmed requests awaiting fulfillment.
 */
class AdminConfirmedRequestController extends Controller
{
    /**
    ...
    /**
     * Display a list of newly confirmed requests ('confirm' status).
     */
    public function index(Request $request): JsonResponse|Response
    {
        ...
        return Inertia::render('Smart/Admin/Fulfillment/ConfirmedList', [
            'user' => $request->user(),
            'requests' => $requests,
