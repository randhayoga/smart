...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Enterprise Portal Connections (RE_PORTALDB)
        'reportal' => [
            'driver' => 'sqlsrv',
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'trust_server_certificate' => env('DB_PORTAL_TRUST_SERVER_CERTIFICATE', env('DB_REPORTAL_TRUST_SERVER_CERTIFICATE', 'true')),
        ],
